  ...
  return (
    <div className="flex flex-col mx-auto">
      ...
      <div className="w-full flex flex-row-2 justify-between items-center gap-10">
        ...
        >
          <h1 className="text-base my-auto text-gray2 justify-center text-center leading-7">
            نمایش<br />
            توضیحات
          </h1>
         </div>
      ...
      <div className="w-full flex border-b py-4 gap-10">
        <div className="w-1/2 mx-6 border text-center border-slate-300 rounded-md shadow py-3 font-normal bg-gray-100">
