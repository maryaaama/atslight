      ...
      <div className="sm:h-11/12 max-sm:w-screen max-w-lg mx-auto sm:border sm:mt-8 sm:rounded-lg sm:items-center sm:shadow-lg">
        ...
        <div className="w-full">
          <div className="flex justify-between mx-6 my-2">
            <div className="text-base text-gray2 font-medium">
              ارزیابی رزومه
            </div>
        ...
        <div className="w-full flex border-t py-5">
          <div className="w-1/2 text-center border border-slate-300 rounded-md shadow mx-7 py-3 font-normal bg-gray-100">
            <Button name="رد صلاحیت" className={""} />
          </div>
          <div className="w-1/2 text-center border border-slate-300 rounded-md shadow mx-7 py-3 font-normal bg-primary text-white">
            <Button name="استخدام" className={""} />
          </div>
        </div>
        <div className="flex flex-row py-4 px-3 justify-between border-t">
          <Button
            className="m-auto text-center border border-slate-300 p-3 text-sm rounded-md bg-[#b23226] text-white shadow font-normal"
            name={"تماس تلفنی"}
          />
          <Button
            className="m-auto text-center border border-slate-300 p-3 text-sm rounded-md shadow font-normal bg-gray-100"
            name={"تماس ویدیویی"}
          />
          <Button
            className="m-auto text-center border border-slate-300 p-3 text-sm rounded-md shadow font-normal bg-gray-100"
